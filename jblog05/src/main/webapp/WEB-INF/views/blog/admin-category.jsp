				...
				<ul class="admin-menu">
		      	...
		      	<table class="admin-cat">
					...
					<tr>
						...
						<a href="${pageContext.request.contextPath}/${id }/${vo.no }/delete?count=${vo.count }">
      			...
      			<form class="insert-form" id="insert-form" method="post" action="${pageContext.request.contextPath}/${id }/updateCategory">
