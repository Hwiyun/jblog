...
<body>
	<div id="container">
		...
		<div id="wrapper">
			...
			<form method="post" action="${pageContext.request.contextPath }/${id }/update" enctype="multipart/form-data">
	 		      	<table class="admin-config">
			      		<tr>
			      			<td class="t">블로그 제목</td>
			      			<td><input type="text" value= "${blogVo.title }" size="40" name="title"></td>
			      		</tr>
			      		<tr>
			      			<td class="t">로고이미지</td>
